...
use cosmwasm_vm::{
    executor::{
        cosmwasm_call, CosmwasmQueryResult, ExecuteCall, ExecutorError, InstantiateCall,
        MigrateCall, QueryCall, QueryResult, ReplyCall,
    },
    has::Has,
...
impl Gas {
    ...
    pub fn charge(&mut self, value: u64) -> Result<(), SimpleVMError> {
...
pub fn instrument_contract(code: &[u8]) -> Vec<u8> {
    let module =

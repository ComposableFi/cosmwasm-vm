...
- [2. Smart Contracts](#2-smart-contracts)
  ...
  - [2.5. Instantiation](#25-instantiation)
    ...
    - [2.5.2. Information Pointer](#252-information-pointer)
      - [2.5.2.1. Block Info](#2521-block-info)
      - [2.5.2.2. Transaction Info](#2522-transaction-info)
      - [2.5.2.3. Contract Info](#2523-contract-info)
      - [2.5.2.4. Message Info](#2524-message-info)
